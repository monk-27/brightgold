...
//     const cardVariant = {
//         collapsed: { height: "auto", opacity: 1, transition: { duration: 0.3, ease: "easeInOut" } },
...
//                             Digi Gold are more than simply an organisation we are a vibrant
...
//                                 <img src="/100gmbar.png" className="mx-auto h-72" alt="100 gm gold bar" />
//                             </motion.div>
//                             <p className="col-span-2 sm:col-span-1 text-white text-left leading-8 mb-4 mt-6 text-xl">
...
//                             </p>
//                             <motion.div variants={fadeIn("right", "spring", 0.5, 0.5)} className="col-span-2 sm:col-span-1 rounded-2xl">
//                                 <img src="/minted-coins.png" className="mx-auto h-72" alt="minted coins" />
//                             </motion.div>
//                         </div>
//                     </div>
//                 </motion.div>
...
//                                         className="rounded-lg overflow-hidden shadow-lg bg-[#13162D] border border-white/[0.1] relative"
//                                     >
//                                         <div
...
//                                                     className={`text-[#BEC1DD] text-sm sm:text-base ${expandedCard === item.id ? "" : "line-clamp-2"
//                                                         }`}
//                                                 >
//                                                     {item.des}
//                                                 </motion.p>
